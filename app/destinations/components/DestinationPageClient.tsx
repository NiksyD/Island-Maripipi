...
export default function DestinationPageClient({ destinationSlug }: DestinationPageClientProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <Suspense fallback={<GettingThereSkeleton />}>
